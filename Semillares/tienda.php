...
<html lang="es-AR">
 ...
 <section>
    ...
    <div id="wraper row" class="container-fluid">

        
        <div class="col-2 lateral-tienda mx-5">

        </div>

        <!-- WRAPER grilla de productos -->
        <div id=" contenido-tienda-wraper" class=" col-6 container">
        ...
        <div class="container px-4 px-lg-5 mt-5 d-none">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->

                        <img class="card-img-top" src="https://picsum.photos/450/300?random=1" alt="..." />
                        <!-- Product details-->
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product image-->
                        <img class="card-img-top" src="https://picsum.photos/450/300?random=2" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
